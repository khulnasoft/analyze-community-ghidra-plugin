...
public class XMLParser extends GhidraScript {
    ...
    protected void run() throws Exception {
        String file_directory = System.getenv("khulnasoft_analyze_ghidra_export_file_path");
    ...
    private void parse(String path) {
        ...
        try {
            ...
            KhulnasoftAnalyzeHandler handler = new KhulnasoftAnalyzeHandler();
    ...
    private void fillTable(List<Row> rowList) {
        ...
        tableDialog = createTableChooserDialog("Khulnasoft Analyze Genes", executor);
    ...
    public class KhulnasoftAnalyzeHandler extends DefaultHandler {
